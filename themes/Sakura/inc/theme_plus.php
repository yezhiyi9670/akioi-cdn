...
function the_headPattern(){
  ...
  <div class="pattern-center <?php if(is_single()){echo $center;} ?>">
    <div class="pattern-attachment-img lazyload" style="background-image: url(https://fastly.jsdelivr.net/gh/moezx/cdn@3.0.1/img/svg/loader/orange.progress-bar-stripe-loader.svg)" data-src="<?php echo $full_image_url; ?>"> </div>
...
function the_video_headPattern_hls(){
  ...
  if(is_single()){
    ...
    $full_image_url = z_taxonomy_image_url();
    $thubm_image_url = 'https://fastly.jsdelivr.net/gh/moezx/cdn@3.0.1/img/svg/loader/orange.progress-bar-stripe-loader.svg';
    $des = category_description() ? category_description() : ''; // 描述
    $t .= '<h1 class="cat-title">'.single_cat_title('', false).'</h1>';
    $t .= ' <span class="cat-des">'.$des.'</span>';
  }elseif(is_search()){
...
function header_user_menu(){
  ...
  <?php
    ...
    $ava = 'https://fastly.jsdelivr.net/gh/moezx/cdn@3.1.9/img/Sakura/images/none.png';
...
function siren_get_useragent($ua){
  if(akina_option('open_useragent')){
    ...
    $imgurl = 'https://fastly.jsdelivr.net/gh/moezx/cdn@3.2.7/img/Sakura/images/ua/svg/';
